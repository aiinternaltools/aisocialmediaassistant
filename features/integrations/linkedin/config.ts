...
/**
 * OpenID scopes identify the member; w_member_social publishes posts.
 * Requires both LinkedIn products: Sign In with LinkedIn (OpenID Connect) + Share on LinkedIn.
 */
