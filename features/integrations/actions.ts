  ...
  try {
    ...
    if (platformId === "instagram" && hasEnvFacebookPageToken()) {
      throw new AppError({
        ...
        userMessage:
          "Instagram can be connected with the Facebook Page token. Use “Connect with page token” instead.",
      })
    }
...
/** Connect Instagram using FACEBOOK_PAGE_ACCESS_TOKEN (resolves linked IG Business account). */
